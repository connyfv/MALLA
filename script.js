const malla = [
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "CC1001", nombre: "Proyectos de Innovación", prerq: ["CC1000"] }
    ]
  },
  {
    nombre: "III Semestre",
  ...
  },
  {
    ...
    cursos: [
      ...
      { codigo: "FI2004", nombre: "Termodinámica", prerq: ["FI2001", "IQ2211", "MA2001"] },
      { codigo: "CD2201", nombre: "Modulo Multidisciplinario", prerq: ["CD1201"] },
